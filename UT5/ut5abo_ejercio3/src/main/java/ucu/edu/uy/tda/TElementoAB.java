...
public class TElementoAB<T> implements IElementoAB<T>
{
    ...
    public void setFrecuencia(int unaFrecuencia) {
...
// tiene los dos hijos, buscamos el lexicograficamente anterior
    ...
    public int obtenerCosto(int nivel) {
        int resultado = 0;
            if (this.getHijoIzq()!= null){
                resultado = resultado + this.getHijoIzq().obtenerCosto(nivel+1);
            }
            if (this.getHijoDer()!= null){
                resultado = resultado + this.getHijoDer().obtenerCosto(nivel+1);
            }
            resultado = resultado + this.getFrecuencia() * nivel;        
            return resultado;        
        }
